...
export function NewItem ({onAddItem})
{
    ...
    return(
            ...
            <form className="w-96 h-44 bg-cyan-800 flex flex-col rounded" onSubmit={handleSubmit}>
                ...
                */}
                <input className="text-black rounded-md m-2 h-10" type="text" name="name" placeholder="Enter Name" value={name} onChange={handleNameChange} required/>
